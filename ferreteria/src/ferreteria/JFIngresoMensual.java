 ...
 * @author OmarGuevara
 */
public class JFIngresoMensual extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Reporte mensual de las compras que se realizan");
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            if (validar() == true) {
                ...
                reporte.generarReporteParametro("ingresoMensualProductos.jasper", listaParametros);
            } 
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFIngresoMensual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFIngresoMensual().setVisible(true);
            }
        });
    }
