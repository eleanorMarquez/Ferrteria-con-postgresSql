 ...
 * @author OmarGuevara
 */
public class JFReporteListaProductos extends javax.swing.JFrame {

    public JFReporteListaProductos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        labelRect1.setText("REPORTE DE PRODUCTOS");
        ...
        jLabel1.setText("Lista de productos con su respectivo stock");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            reporte = new Reporte();
            reporte.generarReporteParametro("listaProductos.jasper", null);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFReporteListaProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFReporteListaProductos().setVisible(true);
            }
        });
    }
